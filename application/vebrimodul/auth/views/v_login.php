                    ...
                    <form method="post" action="<?php echo base_url('auth/login'); ?>" role="login">
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <div class="flex items-center mr-auto">
                                ...
                                <a class="button button--lg w-full xl:w-32 text-gray-700 border border-gray-300 xl:text-right" href="<?php echo base_url('auth/register') ?>" style="margin-left: 10px;">Register</a>
                            </div>
                        </div>
