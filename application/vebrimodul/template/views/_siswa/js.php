...
<!-- <script src="<?php echo base_url(); ?>assets/modules/datetimepicker/js/bootstrap-datetimepicker.js"></script> -->
<!-- <script src="<?php echo base_url(); ?>assets/modules/datetimepicker/js/locales/bootstrap-datetimepicker.id.js"></script> -->
